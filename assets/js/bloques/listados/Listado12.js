class Listado12 extends Listado {
  
  id = 'li_012';
  data = {
        nombre:'Titulo, listado número borde',
        data:{
...
render(){
      ...
      html+='     <div class="d-block msp-80 mep-20">';
      html+='         <div class="row p-0 m-0">';
      html+='         <div class="border border-3 border-color-lightDark p-2 ">';
      ...
      html+='                 <ol class="msp-20 p-0 arrastar">';   
  ...
  renderOpcion(opcion){
    return '<li class="opcion color-primary fw-600"><div class="handle"><i class="fas fa-th"></i></div><span class="color-hardDark fw-300"><div class="editable li-editable" contenteditable="true" data-docid="'+opcion.doc_id+'">'+opcion.texto+'</div></span><div class="remove-li" data-docid="'+opcion.doc_id+'"><i class="fas fa-trash-alt"></i></div></li>';
  }
